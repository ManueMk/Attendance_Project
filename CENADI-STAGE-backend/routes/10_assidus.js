...
router.post("/10_assidus",authMiddleware, (req, res, next) => {
                          ...
                          db.query(
                            ...
                            (err, result) => {
                              ...
                              if (result.rows[0]) {
                                ...
                                WHERE
                                  "presences"."date" BETWEEN $1::date AND $2::date AND presences."isdeleted" = 0
                                GROUP BY
                                  "presences"."matricule",
                                  "agt"."nom",
                                  "agt"."prenom",
                                ...
                                LIMIT 10`,
                                  ...
                                  (err, result) => {
                                    ...
                                    if (result.rows) {
                                      return res
                                        .status(200)
                                        .json({ les_10_personne_les_plus_assidus: result.rows});
                                    } else {
                                      return res
                                        .status(500)
                                        .json({
